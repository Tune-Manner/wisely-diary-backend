...
public class CartoonController {
    ...
    public ResponseEntity<String> createLetterCartoon(@RequestBody CreateCartoonRequest request) {
        log.info("CartoonController.createLetterCartoon");

        String letterCartoonUrl = cartoonService.createLetterCartoonPrompt(request);
        String result = letterCartoonUrl;
